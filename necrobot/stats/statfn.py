...
class StatCache(object):
    class __StatCache(object):
        ...
        def get_general_stats(self, discord_id, amplified):
            last_race_number = necrobot.database.matchdb.get_largest_race_number(discord_id)
            ...
            for row in necrobot.database.racedb.get_allzones_race_numbers(discord_id, amplified):
                ...
                for stat_row in necrobot.database.racedb.get_all_racedata(discord_id, char.name, amplified):
...
def get_most_races_infotext(ndchar, limit):
    most_races = necrobot.database.racedb.get_most_races_leaderboard(character.get_str_from_char(ndchar), limit)
...
def get_fastest_times_infotext(ndchar, amplified, limit):
    fastest_times = necrobot.database.racedb.get_fastest_times_leaderboard(character.get_str_from_char(ndchar), amplified, limit)
